...
| Stripe 수수료 (¥500 × 100건) | ~¥1,800 (3.6%) ≈ $11 |
| **LLM 총계 (CFO 한도 $10 이내)** | **$0.75~$10** |

**손익분기:** 월 1~2건 결제로 운영비 회수 (실 BEP — CFO 2026-06-11 재계산, 고정비 $0 기준) → 즉시 흑자 구조
