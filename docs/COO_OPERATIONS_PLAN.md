...
| **W7** | 07/19–07/25 | Korea Phase 2 개발 착수 | 브랜드명 최종 결정 (사주팔자 상표 리스크 검토 후) | Korea worker/index.js 스켈레톤 → 완성본 개발, 카카오페이 연동 설계 | Korea CF Workers 로컬 테스트 통과 |
...
| 사주팔자 상표 분쟁 | 중간 | 낮음 | Korea 브랜드는 별도명으로 출시 (Phase 2까지 시간 있음) |
